<?php
	...
	try {
		...
		$binu_app->add_text("Telecel Helpdesk App -> Home",'header');	
		$binu_app->add_text("",'intro');		
		
		$binu_app->add_link("../home_where/", "Where we are", "intro");
		$binu_app->add_link("../home_contact/", "Contact Us", "intro");
		$binu_app->add_link("../home_histry/", "Our History", "intro");
		$binu_app->add_link("../home_experiences/", "My Experiences", "intro");
