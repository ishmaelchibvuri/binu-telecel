<?php
	...
	try {
		...
		$binu_app->add_text("Telecel Helpdesk App -> Home -> History",'header');	
		$binu_app->add_text("",'intro');		
		
		$binu_app->add_link("#", "facebook_like_comes_here", "body_text");
		$binu_app->add_link("#", "twitter_follow_comes_here", "body_text");
