<?php
	...
	try {
		...
		$binu_app->add_text("Telecel Helpdesk App -> Products/Services",'header');	
		$binu_app->add_text("",'intro');		
		
		$binu_app->add_link("../products_text/", "Text", "intro");
		$binu_app->add_link("../products_call/", "Call", "intro");
		$binu_app->add_link("../products_surf/", "Surf", "intro");
		$binu_app->add_link("../products_general/", "General", "intro");
